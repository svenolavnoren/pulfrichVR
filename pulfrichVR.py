...
#             --b 360 bat runner renamed to Image generator
...
WORKSHOP_LABEL = "Image generator"  # 0.9-049
APP_TITLE = APP_NAME               # 0.9-087: use pulfrichVR as window title

# 0.9-043: arbetsmapp för one-shot-bilder (L/R-png) 
MONO_DIR_NAME = "VideoOneshot" # 0.9-091a "Obsolete" line put back. It repaired Archice all which was broken from 0.9-088 where we cleaned up the code right here.
